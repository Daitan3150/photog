                        ...
                        <div className="pt-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <button
                                    ...
                                    className="w-full p-4 border border-gray-200 rounded-2xl bg-white hover:bg-gray-50 transition-all flex items-center justify-center gap-2 font-bold text-gray-700 shadow-sm disabled:opacity-50"
                                >
                                    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M16.32 15.688c-.017.067-.229.83-.984 1.956-1.042 1.55-2.115 3.093-3.834 3.123-1.683.033-2.222-1.006-4.14-1.006-1.92 0-2.525.975-4.142 1.04-1.685.066-2.909-1.65-3.955-3.155-2.13-3.093-3.766-8.729-1.583-12.526 1.082-1.884 3.016-3.085 5.12-3.12 1.65-.034 3.193 1.11 4.214 1.11 1.018 0 2.883-1.378 4.887-1.178 2.067.202 3.932 1.205 5 2.766-4.524 2.714-3.833 9.07 1.417 11.046zM11.696 4.453c1.013-1.222 1.693-2.924 1.508-4.634-1.46.06-3.237.973-4.28 2.22-1.196 1.43-1.859 3.078-1.508 4.706 1.65.132 3.18-.89 4.28-2.292z" /></svg>
                                    Apple 登録
                                </button>
                            </div>
