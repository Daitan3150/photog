...
export default function RecentWorksSlider({ photos }: { photos: any[] }) {
    ...
    return (
        <div className="relative w-full bg-[#050505] py-12 md:py-16 overflow-hidden border-y border-white/10">
                ...
                >
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 md:p-8 z-30 translate-y-4 md:translate-y-10 md:group-hover:translate-y-0 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-700 ease-out flex flex-col items-start pointer-events-none">
                                ...
                                <h3 className="text-xl md:text-4xl font-serif text-white tracking-[0.1em] drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] mb-3">
                                    {currentPhoto.title || 'Untitled Masterpiece'}
                                </h3>

                                <div className="flex flex-wrap items-center gap-3 text-xs md:text-sm text-white/70 tracking-[0.2em] font-light uppercase">
                                ...
                                {currentPhoto.uploaderName && (() => {
                                    ...
                                    return (
                                        <div className="mt-4 flex items-center gap-3 bg-black/40 px-3 py-2 rounded-full border border-white/10 backdrop-blur-md pointer-events-auto">
                                ...
                                <Link
                                    ...
                                    className="mt-5 pointer-events-auto flex items-center gap-3 text-xs tracking-[0.3em] text-white hover:text-amber-300 uppercase group/btn bg-white/10 hover:bg-white/20 px-5 py-2.5 rounded-sm backdrop-blur border border-white/20 transition-all"
                                >
