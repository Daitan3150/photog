/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 28cf33422de93166084110325693c0b4)
// Runtime types generated with workerd@1.20260217.0 2024-02-19 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PhotoCounter";
	}
	interface Env {
		PORTFOLIO_CACHE: KVNamespace;
		DB: D1Database;
		ALLOWED_ORIGIN: "https://next-portfolio-lime-one.vercel.app";
		PHOTO_COUNTER: DurableObjectNamespace<import("./src/index").PhotoCounter>;
	}
}
